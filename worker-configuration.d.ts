/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 978cb512179f67f7ea0046688c0f13b3)
// Runtime types generated with workerd@1.20250906.0 2025-08-23 nodejs_compat
declare namespace Cloudflare {
    interface Env {
        ...
        D1: D1Database;
        ASSETS: Fetcher;
        // Feature flags for API routes (string values from environment)
        FEATURE_AUTH: string;
        FEATURE_PUBLIC: string;
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_BETTER_AUTH_URL" | "AUTUMN_SECRET_KEY">> {}
}
